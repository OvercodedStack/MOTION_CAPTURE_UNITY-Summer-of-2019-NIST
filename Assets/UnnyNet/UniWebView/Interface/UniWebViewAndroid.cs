...
public class UniWebViewInterface {
    ...
    static UniWebViewInterface() {
        var go = new GameObject("WebViewAndroidStaticListener");
        go.AddComponent<WebViewAndroidStaticListener>();
        plugin = new AndroidJavaClass("com.unnynet.webview.WebViewInterface");
        CheckPlatform();
